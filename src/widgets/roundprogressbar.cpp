...
void RoundProgressBar::setMinimum(double min) { setRange(min, m_max); }

void RoundProgressBar::setMaximum(double max) { setRange(m_min, max); }
...
void RoundProgressBar::setValue(int val) { setValue(double(val)); }
...
void RoundProgressBar::calculateInnerRect(const QRectF & /*baseRect*/, double outerRadius, QRectF &innerRect,
                                          double &innerRadius) {
