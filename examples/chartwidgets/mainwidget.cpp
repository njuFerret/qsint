...
void MainWidget::on_AddRandomButton_clicked() {
  ...
  ui->PieChart->addData("", QColor(random->bounded(256), random->bounded(256), random->bounded(256)),
                        random->bounded(200) - 100);
}

void MainWidget::on_ResetButton_clicked() { ui->PieChart->clear(); }
